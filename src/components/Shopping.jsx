...
import { FaFireAlt, FaUtensils, FaEgg, FaLeaf, FaCookieBite, FaGift } from 'react-icons/fa';
                    ...
                    {editingItem && editingItem.list === listName && editingItem.index === index ? (
                        ...
                        <div style={{ display: 'flex', flex: 1, gap: '10px' }}>
                            <input
                                ...
                                //הוספת האפשרות לשמירה ע"י לחיצה על אנטר
                                onKeyDown={(e) => {
                                    if (e.key === 'Enter') {
                                        handleSave();
                                    }
...
const sections = [
    { title: 'רשימת קניות בסיסית לשבת', name: 'basic', icon: <FaFireAlt /> },
    { title: 'רשימת קניות לסעודה ראשונה', name: 'firstMeal', icon: <FaUtensils /> },
    { title: 'רשימת קניות לסעודה שניה', name: 'secondMeal', icon: <FaEgg /> },
    { title: 'רשימת קניות לסעודה שלישית', name: 'thirdMeal', icon: <FaLeaf /> },
    { title: 'רשימת קניות עבור ארוח', name: 'meal', icon: <FaCookieBite /> },
    { title: 'רשימת קניות עבור התארחות', name: 'hosting', icon: <FaGift /> }
];
